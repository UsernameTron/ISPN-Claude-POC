...
async function createPresentation() {
  ...
  slide2.addText([
    { text: '$7.8M+ total annual value creation across all executives', options: { bullet: true } },
    { text: '3-7 day payback period on initial investment', options: { bullet: true } },
    { text: '30-70% time savings on operational workflows', options: { bullet: true } },
    { text: 'Real-time intelligence replacing manual data synthesis', options: { bullet: true } },
    { text: 'Accelerated strategic initiative velocity by 30-40%', options: { bullet: true } }
  ], {
    x: 0.8, y: 2.5, w: 8.5, h: 2.2,
    fontSize: 14, color: '2E4053'
  });
  ...
  slide4.addText([
    { text: 'Board preparation time: 20 hrs → 2 hrs', options: { bullet: true } },
    { text: 'Real-time competitive intelligence synthesis', options: { bullet: true } },
    { text: 'M&A deal analysis acceleration', options: { bullet: true } },
    { text: 'Executive communication automation', options: { bullet: true } }
  ], {
    x: 0.9, y: 1.9, w: 3.6, h: 2.2,
    fontSize: 12, color: '2E4053'
  });
  ...
  slide5.addText([
    { text: 'Code review time: 10 hrs → 2 hrs/week', options: { bullet: true } },
    { text: 'Auto-generated technical documentation', options: { bullet: true } },
    { text: 'Architecture analysis & recommendations', options: { bullet: true } },
    { text: 'Security vulnerability detection', options: { bullet: true } }
  ], {
    x: 0.9, y: 1.9, w: 3.6, h: 2.2,
    fontSize: 12, color: '2E4053'
  });
  ...
  slide6.addText('Charlie Brenneman - SVP Operations', {
    x: 0.5, y: 0.4, w: 9, h: 0.6,
  ...
  slide6.addText([
    { text: 'Portfolio synthesis: 4 hrs → 10 min daily', options: { bullet: true } },
    { text: 'Real-time initiative health monitoring', options: { bullet: true } },
    { text: 'Cross-functional alignment acceleration', options: { bullet: true } },
    { text: 'Automated board reporting', options: { bullet: true } }
  ], {
    x: 0.9, y: 1.9, w: 3.6, h: 2.2,
    fontSize: 12, color: '2E4053'
  });
  ...
  slide7.addText('Ty Sorensen - VP Sales/Marketing/CS', {
    x: 0.5, y: 0.4, w: 9, h: 0.6,
    fontSize: 28, bold: true, color: '1C2833'
  });
  ...
  slide7.addText([
    { text: 'Forecast accuracy: ±18% → ±8%', options: { bullet: true } },
    { text: 'Predictive customer health scoring', options: { bullet: true } },
    { text: 'Marketing content velocity 7x increase', options: { bullet: true } },
    { text: 'Proactive churn prevention', options: { bullet: true } }
  ], {
    x: 0.9, y: 1.9, w: 3.6, h: 2.2,
    fontSize: 12, color: '2E4053'
  });
  ...
  slide8.addText([
    { text: 'Close cycle: 7 days → 4 days', options: { bullet: true } },
    { text: 'Automated reconciliation verification', options: { bullet: true } },
    { text: 'Real-time exception identification', options: { bullet: true } },
    { text: 'Audit-ready documentation generation', options: { bullet: true } }
  ], {
    x: 0.9, y: 1.9, w: 3.6, h: 2.2,
    fontSize: 12, color: '2E4053'
  });
  ...
  slide11.addText([
    { text: 'Decision velocity 3-4x faster than competitors', options: { bullet: true } },
    { text: 'Real-time market intelligence vs reactive analysis', options: { bullet: true } },
    { text: 'Strategic initiative execution velocity +30-40%', options: { bullet: true } },
    { text: 'Board-level visibility unprecedented in industry', options: { bullet: true } }
  ], {
    x: 0.7, y: 1.7, w: 4.2, h: 1.8,
    fontSize: 13, color: '2E4053'
  });
  ...
  slide11.addText([
    { text: 'Executives focus on strategy vs operations', options: { bullet: true } },
    { text: 'Data-driven decisions replace intuition', options: { bullet: true } },
    { text: 'Cross-functional alignment accelerated', options: { bullet: true } },
    { text: 'Predictive capabilities vs reactive firefighting', options: { bullet: true } }
  ], {
  ...
  slide12.addText([
    { text: 'Enterprise-grade Claude deployment', options: { bullet: true } },
    { text: 'Zero data retention by Anthropic', options: { bullet: true } },
    { text: 'SOC 2 Type II certified infrastructure', options: { bullet: true } },
    { text: 'End-to-end encryption in transit and at rest', options: { bullet: true } }
  ], {
    x: 0.7, y: 1.7, w: 4.2, h: 1.8,
    fontSize: 13, color: '2E4053'
  });
  ...
  slide12.addText([
    { text: 'GDPR and CCPA compliant', options: { bullet: true } },
    { text: 'Complete audit trail of all AI interactions', options: { bullet: true } },
    { text: 'Human oversight on critical decisions', options: { bullet: true } },
    { text: 'Regular security audits and monitoring', options: { bullet: true } }
  ], {
    x: 5.2, y: 1.7, w: 4.3, h: 1.8,
    fontSize: 13, color: '2E4053'
  });
  ...
  const timeline = [
    { phase: 'Phase 1: Foundation (Weeks 1-2)', desc: 'Technical setup, MCP integrations, pilot training', color: '1C2833' },
    { phase: 'Phase 2: Executive Pilots (Weeks 3-6)', desc: 'Deploy to CEO & CTO, validate value, refine workflows', color: '2E4053' },
    { phase: 'Phase 3: Scale (Weeks 7-10)', desc: 'Deploy to remaining executives, optimize processes', color: '5D6D7E' },
    { phase: 'Phase 4: Optimization (Weeks 11+)', desc: 'Continuous improvement, expand use cases, measure ROI', color: 'AAB7B8' }
  ];
  ...
  slide15.background = { fill: '1C2833' };
