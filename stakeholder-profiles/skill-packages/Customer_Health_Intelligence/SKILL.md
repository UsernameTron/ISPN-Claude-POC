...
PORTFOLIO OVERVIEW:
• 47 Active Accounts: 34 Green (72%), 9 Yellow (19%), 4 Red (9%)
• Total ARR: $4.23M
• Renewals Next 90 Days: 8 accounts ($847K ARR)
• Churn Risk: $393K ARR in Red accounts requiring immediate intervention

CRITICAL ALERTS (Executive Action Required):
[RED] Lincoln County Schools - $180K ARR
  • Renewal: March 15, 2025 (59 days)
  • Health Score: 42/100
  • Churn Probability: 72%
  • Primary Risk: Service quality deterioration + leadership change + competitive inquiry
  • Recommended Action: CEO executive call + technical root cause resolution + retention offer
  • Business Impact: $180K ARR ($540K 3-year contract value)

RETENTION VALUE AT RISK:
• Red Accounts: $393K ARR (4 accounts) - Executive intervention required this week
• Yellow Accounts: $732K ARR (9 accounts) - CSM-led retention campaigns next 30 days
• Without intervention: $240K estimated churn (65% average probability across Red)
• With proactive intervention: $295K preservation (75% retention rate with executive engagement)
```
...
• Support Quality: 6/25 (12 escalated tickets, 3 critical outages, 40% SLA miss rate)
• Engagement: 8/25 (Missed last 3 QBRs, email response time 3-5 days vs <24hr historical)
• Product Usage: 10/20 (85% bandwidth utilization constrained, 98.2% uptime vs 99.5% target)
• Relationship: 8/15 (6-year customer, declining engagement, no expansions 3 years)
• Sentiment: 10/15 (Negative tone, frustration with support response time)

CHURN PROBABILITY CALCULATION:
• Base probability (score 42): 70%
• Renewal <60 days: +20% = 90%
• Leadership change (new superintendent Sept 2024): +15% = 105%
• Competitive inquiry (regional fiber provider Dec 2024): +25% = 130%
• Service issues (3 outages Q4): +15% = 145%
...
• New superintendent not engaged (relationship building opportunity missed)
• Technology director frustrated with repeat issues (escalation pattern evident)
...
VALUE AT RISK:
• Annual ARR: $180K
• 3-Year Contract Value: $540K
• Customer Lifetime Value: $900K (estimated 5-year tenure if retained)
```

### 3. Retention Strategy Development

**What Claude Creates:**
- Multi-phase retention roadmap (Immediate → Short-term → Renewal)
...
1. CEO Executive Call (CEO Jeff Neblett → Superintendent)
   ...
   • Owner: CEO Jeff Neblett | Timeline: Call by Friday Jan 19
...
2. Technical Root Cause Resolution (VP Operations → Tech Director)
   ...
   • Owner: VP Operations | Timeline: Audit by Jan 20, issues resolved by Jan 22

3. Support Process Improvement (VP Customer Success → All Stakeholders)
   • Assign dedicated escalation contact (direct line to VP Operations)
   • Implement proactive monitoring alerts (prevent issues before impact)
   • Weekly check-in calls with tech director (rebuild trust)
   • Owner: VP Customer Success | Timeline: In place by Jan 22
...
4. Executive QBR & Service Recovery (Week of Jan 27)
   ...
   • Review performance metrics and address uptime concerns
   • Discuss 3-year partnership vision (not just transactional renewal)
   • Owner: CEO + VP Sales + VP Operations | Timeline: QBR by Feb 5

5. Customized Retention Offer (Week of Feb 3)
   • Service credits for Q4 outages ($15K = 3 months service)
   • Bandwidth upgrade 500Mbps → 1Gbps at no incremental cost
   • 3-year pricing lock (protect against inflation, address budget concerns)
   • Enhanced SLA (99.95% uptime vs 99.9% standard)
   • Owner: VP Sales + CFO (pricing approval) | Timeline: Proposal by Feb 10

RENEWAL STRATEGY (Feb 15 - March 15):
6. Contract Negotiation & Closing (Feb 15 - March 1)
   • Present renewal proposal (service recovery + retention offer + value narrative)
   • Address objections (price, performance, competitive alternatives)
   • Board presentation support if needed (materials, attend meeting)
   • Secure signed contract minimum 2 weeks before expiration
   • Owner: VP Sales + Account Executive | Timeline: Signed by March 1

SUCCESS METRICS:
• Weekly: Open ticket status, response time, escalation tracking
• Bi-weekly: Executive update on relationship progress
• Monthly: Health score recalculation (target 75+ by March, 85+ by June)
• Outcome: Retention + health improvement + expansion opportunity identification
```
...
1. Bear Creek School District - $142K current ARR, 92/100 health score
   • Opportunity: New campuses (3 locations requiring connectivity)
   • Potential ARR: +$55K
   • Timing: Board approved campus openings August 2025, E-rate deadline May 1
   • Close Probability: 75% (strong relationship, budgeted project)
   • Recommended Action: Proactive outreach by Jan 31, proposal by Feb 15, close by April 30

2. Riverside Unified - $125K current ARR, 89/100 health score
   • Opportunity: Bandwidth upgrade (500Mbps → 1Gbps)
   • Potential ARR: +$45K
   • Timing: Network capacity constraints emerging, technology plan refresh Q2
   • Close Probability: 70% (identified need, strong usage pattern)
   • Recommended Action: QBR discussion Feb 15, capacity analysis, proposal by March 1
...
• High Priority: Account executive proactive outreach, dedicated proposal resources
• Medium Priority: CSM-led discovery during QBRs, sales support as needed
• Low Priority: Opportunistic mentions during regular check-ins, no dedicated campaigns
```
...
**Time Savings:** 3-4 hours manual QBR prep → 20 minutes validation = 2.5+ hours saved per QBR
...
5. Prioritizes by expected value (potential ARR × close probability)
...
✓ Green Accounts: [count] ([percentage]%) - $[ARR]
⚠ Yellow Accounts: [count] ([percentage]%) - $[ARR]
🔴 Red Accounts: [count] ([percentage]%) - $[ARR]
...
• Red Accounts: $[ARR] at risk - Executive intervention required
• Yellow Accounts: $[ARR] at risk - CSM-led retention campaigns
• Expected Churn Without Intervention: $[ARR] ([percentage]% portfolio)
• Expected Retention With Intervention: $[ARR] ([percentage]% success rate)

## EXPANSION PIPELINE
• High Priority: [count] accounts, $[potential ARR], [close rate]% = $[expected ARR]
• Medium Priority: [count] accounts, $[potential ARR], [close rate]% = $[expected ARR]
• Total Expected Expansion: $[total expected ARR] (Q1-Q2 2025)
