...
- **Early Warning Signals Detected:**
  - Support ticket volume up 300% (8 tickets/month → 24 tickets/month, past 60 days)
...
- **Early Warning Signals Detected:**
  - Budget variance accelerating: +4% (Week 1) → +8% (Week 2) → +12% (Week 3)
...
|---------------|----------|------|--------|-----|----------------------|
| Initiative    | 2        | 4    | 8      | 12  | ↑ Worsening (+1 critical) |
| Customer      | 1        | 3    | 7      | 28  | → Stable |
| Financial     | 0        | 2    | 5      | 10  | ↑ Worsening (+1 high) |
| Compliance    | 0        | 1    | 3      | 8   | → Stable |
...
|----------------|-------|--------|-------|
| Timeline Risk | 92 | 🔴 CRITICAL | ↑ Worsening |
| Budget Risk | 65 | 🟡 HIGH | → Stable |
| Resource Risk | 88 | 🔴 CRITICAL | ↑ Worsening |
| Dependency Risk | 72 | 🟡 HIGH | ↑ Worsening |
| Stakeholder Risk | 58 | 🟡 MEDIUM | ↓ Improving |

## EARLY WARNING SIGNALS DETECTED

### Timeline Risk: 3-Week Delay Imminent
- **Signal 1:** Velocity decline 25% over past 3 sprints (14 → 12 → 10.5 tasks/sprint)
...
**Sentiment Shifts:**
- Email/Slack tone analysis: Positive → Neutral → Negative progression
...
|----------------|-------|--------|---------------------|
| Usage Trend | 65 | 🟡 HIGH | 60 days before renewal |
| Support Health | 88 | 🔴 CRITICAL | 45 days before escalation |
| Satisfaction | 72 | 🟡 HIGH | 90 days before churn decision |
| Engagement | 81 | 🔴 CRITICAL | 75 days before ghosting |
| Renewal History | 45 | 🟡 MEDIUM | Baseline risk |
| Competitive Threat | 58 | 🟡 MEDIUM | 60 days before RFP |
...
- **Resolution Delays:** Average resolution time: 2.8 days → 5.4 days (+93%)
...
- **Login Frequency:** Down 35% over past 60 days (daily logins → every 3 days)
...
- **Specific Language Shifts:** "We appreciate..." → "We need..." → "We require immediate..."
...
- **Expected Loss:** $117K (= $180K × 65% probability)
...
## CONFLICT ANALYSIS
- **Team Capacity:** 100 hours/week (4 engineers × 25 hrs/week)
...
1. **Alert Fatigue:** Too many low-priority alerts → desensitization → critical alerts missed
